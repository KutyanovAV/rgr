...
public class vkl_1 extends JPanel  {
	...
	private JButton but_vkl, but_new,linkButton;// кнопка Рассчитать которая доступна только для данного класса
	private JLabel label_1,label_2,label_3,label_4, label_5, label_6, label_7, label_8, label_9, 
	label_10, label_11,label_12, label_13,label_15; // Панели на которых располагается текст
	...
	public vkl_1() { 
		...
		try {
			uri = new URI("http://www.ufakirovugh.ru/rates/");
		...
		/*Модификатор доступа public означает, что метод Index()виден и доступен любому классу.
		...
		linkButton = new JButton("Актуальные нормативы");
		...
		*/
		...
		but_new = new JButton("Тарифы и нормативы 2019 года"); //В скобках - надпись на кнопке
